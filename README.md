...
var c = new Calendula({
  ...
  value: '2014-10-11', // выбранная дата в формате YYYY-MM-DD, по умолчанию - текущая дата.
  min: '2013-10-11', // минимальная дата в формате YYYY-MM-DD.
  min: '2015-10-11', // максимальная дата в формате YYYY-MM-DD.
